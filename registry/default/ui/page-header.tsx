...
type TPageHeaderProps = ComponentProps<'div'> &
  ...
  return (
    <PageHeaderContext.Provider value={{ size: contextSize }}>
      <div
        ...
        className={cn(
          pageHeaderVariants({ size: contextSize, background, border }),
          className
        )}
        {...props}
      >
...
function PageHeaderEyebrow({
  variant = 'gold',
  ...props
}: TPageHeaderEyebrowProps) {
  return (
    <Eyebrow data-slot="page-header-eyebrow" variant={variant} {...props} />
  );
}
...
function PageHeaderTitle({
  ...
  children,
  ...props
}: TPageHeaderTitleProps) {
  return (
    <h1
      data-slot="page-header-title"
      className={cn('text-3xl tracking-tight scroll-m-20', className)}
      {...props}
    >
      {children}
    </h1>
