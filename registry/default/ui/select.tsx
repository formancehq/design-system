...
const selectTriggerVariants = cva(
  'flex w-full items-center justify-between border border-input bg-muted-lighter dark:bg-input/30 dark:hover:bg-input/50 px-3 py-2 text-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
  {
    variants: {
      size: {
        sm: 'h-7',
