...
function Carousel({
  ...
  children,
  ...props
}: React.ComponentProps<'div'> & TCarouselProps) {
...
function CarouselPrevious({
  className, variant = 'outline', size = 'icon-md', ...props
}: React.ComponentProps<typeof Button>) {
  const { orientation, scrollPrev, canScrollPrev } = useCarousel();
  return (
    <Button
      data-slot="carousel-previous" variant={variant} size={size}
...
function CarouselNext({
  ...
  return (
    <Button
      data-slot="carousel-next" variant={variant} size={size}
