		...
		<footer className='mx-auto max-w-[1400px] w-full border-x'>
			...
			<div className='flex items-center justify-between px-6 py-4 text-sm text-muted-foreground'>
				<div className='flex items-center gap-2'>
					...
					<a href='https://formance.com' target='_blank' rel='noopener noreferrer' className='text-foreground'>
						<FormanceLogo className='min-w-24 max-w-28' />
					</a>
				</div>
				<div className='flex items-center'>
					<Button variant='bracketed' size='sm' asChild>
						<a href='https://github.com/formancehq/design-system' target='_blank' rel='noopener noreferrer'>
							GitHub
						</a>
					</Button>
					<Button variant='bracketed' size='sm' asChild>
						<a href='https://www.formance.com' target='_blank' rel='noopener noreferrer'>
							Website
						</a>
					</Button>
				</div>
