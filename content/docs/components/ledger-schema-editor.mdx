...
- `base` (default) — the strict contract; rejects unknown top-level keys. Use it to author ledger schemas.
- `extended` — the base contract plus a top-level `meta` block, for docs / library entries that carry metadata.
